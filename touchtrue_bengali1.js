	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			' আপনি যদি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে. ' +
			' চালিয়ে যেতে অন্য কী টিপুন। <p/>',

			remindErrorTextTouch : '<p align="center" style="font-size:"1.4em"; font-family:arial">' +
			' আপনি যদি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। ' +
			' চালিয়ে যেতে অন্য দিকে স্পর্শ করুন.<p/>',
			...
			finalText : ' পরবর্তী কাজ চালিয়ে যেতে স্পেস টিপুন ', 
			finalTouchText : ' পরবর্তী কাজ চালিয়ে যেতে নীচের সবুজ এলাকায় স্পর্শ করুন ',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				' একটি বাম আঙুল রাখুন উপর <b>E</b> ক্যাটাগরির অন্তর্গত আইটেমগুলির জন্য <font color="#0000ff">leftAttribute.</font>' +
				'<br/> একটি ডান আঙুল রাখুন <b>I</b> ক্যাটাগরির অন্তর্গত আইটেমগুলির জন্য <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
				' আপনি যদি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। ' +
				' চালিয়ে যেতে অন্য কী টিপুন.<br/>' +
				'<u> নির্ভুল থাকাকালীন আপনি যত তাড়াতাড়ি পারেন </u> যান <br/><br/></p>'+
				'<p align="center"> আপনি যখন শুরু করতে প্রস্তুত তখন <b> স্পেস বার </b> টিপুন.</font></p></div>',
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						' ক্যাটাগরির অন্তর্গত আইটেমগুলির জন্য <b> বাঁ </b> সবুজ এলাকায় একটি বাঁ আঙুল রাখুন <font color="#0000ff">leftAttribute</font>.<br/>',
						' ক্যাটাগরির অন্তর্গত আইটেমগুলির জন্য <b> ডান </b> সবুজ এলাকার উপর একটি ডান আঙুল রাখুন <font color="#0000ff">rightAttribute</font>.<br/>',
						' আইটেমগুলো এক এক করে প্রদর্শিত হবে.<br/>',
						'<br/>',
						' আপনি যদি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। অন্য দিকে স্পর্শ করুন। <u> নির্ভুল থাকাকালীন আপনি যত তাড়াতাড়ি পারেন </u> যান ',
					'</p>',
					'<p align="center"> শুরু করতে <b> নীচের </b> সবুজ এলাকায় স্পর্শ করুন।.</p>',
				'</div>'
			].join('\n'),
			...
			instCategoriesPractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				' ক্যাটাগরির অন্তর্গত আইটেমগুলির জন্য <b>E</b> কীটিতে একটি বাঁ আঙুল রাখুন৷ <font color="#336600">leftCategory</font>. ' +
				'<br/> ক্যাটাগরির অন্তর্গত আইটেমগুলির জন্য <b>I</b> কীটিতে ডান আঙুল রাখুন <font color="#336600">rightCategory</font>.<br/>' +
				' আইটেমগুলো এক এক করে প্রদর্শিত হবে.<br/><br/>' +
				' আপনি যদি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। ' +
				' চালিয়ে যেতে অন্য কী টিপুন.<br/>' +
				'<u> নির্ভুল থাকাকালীন আপনি যত তাড়াতাড়ি পারেন </u> যান৷.<br/><br/></p>'+
				'<p align="center"> আপনি যখন শুরু করতে প্রস্তুত তখন <b> বার </b> টিপুন। </font></p></div>',
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						' ক্যাটাগরির অন্তর্গত আইটেমগুলির জন্য <b> বাঁ </b> সবুজ এলাকায় একটি বাঁ আঙুল রাখুন <font color="#336600">leftCategory</font>.<br/>',
						' ক্যাটাগরির অন্তর্গত আইটেমগুলির জন্য <b> ডান </b> সবুজ এলাকার উপর একটি ডান আঙুল রাখুন <font color="#336600">rightCategory</font>.<br/>',
						' আইটেমগুলো এক এক করে প্রদর্শিত হবে।.<br/>',
						'<br/>',
						' আপনি যদি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। অন্য দিকে স্পর্শ করুন। <u> নির্ভুল থাকাকালীন আপনি যত তাড়াতাড়ি পারেন </u> যান ',
					'</p>',
			...
			instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				' ব্যবহার <b>E</b> এবং এর জন্য <font color="#336600">leftCategory</font> কী ব্যবহার করুন <font color="#0000ff">leftAttribute</font>.<br/>' +
				' <b>I</b> কী ব্যবহার করুন <font color="#336600">rightCategory</font> এবং এর জন্য  <font color="#0000ff">rightAttribute</font>.<br/>' +
				'প্রতিটি আইটেম শুধুমাত্র একটি ক্যাটাগরির অন্তর্গত.<br/><br/>' +
				'আপনি যদি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে।. ' +
				'চালিয়ে যেতে অন্য কী টিপুন.<br/>' + 
				'<u>নির্ভুল থাকাকালীন আপনি যত তাড়াতাড়ি পারেন</u> যান।.<br/><br/></p>' +
				'<p align="center">আপনি যখন শুরু করতে প্রস্তুত তখন <b>স্পেস বার</b> টিপুন</font></p></div>',
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						' উপরে একটি বাম আঙুল রাখুন <b> বাম </b> জন্য সবুজ এলাকা <font color="#336600">leftCategory</font> আইটেম এবং এর জন্য <font color="#0000ff">leftAttribute</font>.</br>',
						' আইটেম এবং এর জন্য <b> ডান </b> সবুজ এলাকার উপর ডান আঙুল রাখুন <font color="#336600">rightCategory</font> <font color="#0000ff">rightAttribute</font>.</br>',
							' আপনি যদি ভুল করেন তাহলে একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। অন্য দিকে স্পর্শ করুন। নির্ভুল থাকাকালীন <u> যত দ্রুত যেতে পারেন </u> </br>',
						'</p>',
						'<p align="center"> শুরু করতে <b> নীচের </b> সবুজ এলাকায় স্পর্শ করুন.</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				' এবং এর জন্য <b>E</b> কী ব্যবহার করুন <font color="#336600">leftCategory</font> <font color="#0000ff">leftAttribute</font>.<br/>' +
				' এবং এর জন্য <b>I</b> কী ব্যবহার করুন <font color="#336600">rightCategory</font>  <font color="#0000ff">rightAttribute</font>.<br/>' +
				' প্রতিটি আইটেম শুধুমাত্র একটি ক্যাটাগরির অন্তর্গত৷ <br/><br/>' +
				'<u> ৷নির্ভুল থাকাকালীন </u> যত দ্রুত যেতে পারেন.<br/><br/></p>' +
				'<p align="center"> আপনি যখন শুরু করতে প্রস্তুত তখন <b> স্পেস বার </b> টিপুন </font></p></div>',
			instSecondCombinedTouch:[
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						' আইটেম এবং এর জন্য <b> বাঁ </b> সবুজ এলাকার উপর একটি বাঁ আঙুল রাখুন <font color="#336600">leftCategory</font> <font color="#0000ff">leftAttribute</font>.<br/>',
						' আইটেম এবং এর জন্য <b> ডান </b> সবুজ এলাকার উপর ডান আঙুল রাখুন <font color="#336600">rightCategory</font> <font color="#0000ff">rightAttribute</font>.<br/>',
						'<br/>',
						'<u> নির্ভুল থাকাকালীন আপনি যত তাড়াতাড়ি পারেন </u> যান৷ <br/>',
					'</p>',
					'<p align="center"> শুরু করতে <b> নীচের </b> সবুজ এলাকায় স্পর্শ করুন।.</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'<b> সাবধান, লেবেল অবস্থান পরিবর্তন হয়েছে!</b><br/>' +
				' এর জন্য <b>E</b> কী-তে বাঁ আঙুল ব্যবহার করুন <font color="#336600">leftCategory</font>.<br/>' +
				' এর জন্য <b>I</b> কী-তে ডান আঙুল ব্যবহার করুন <font color="#336600">rightCategory</font>.<br/><br/>' +
				'<u> নির্ভুল থাকাকালীন আপনি যত তাড়াতাড়ি পারেন </u> যান।.<br/><br/></p>' +
				'<p align="center"> আপনি যখন শুরু করতে প্রস্তুত তখন <b> স্পেস বার </b> টিপুন.</font></p></div>',
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						' সাবধান, লেবেল অবস্থান পরিবর্তন হয়েছে!<br/>',
							' একটি বাঁ আঙুল <b> বাঁ </b> সবুজ এলাকার উপর রাখুন <font color="#336600">leftCategory</font> items.<br/>',
							' এর জন্য <b> ডান </b> সবুজ এলাকার উপর একটি ডান আঙুল রাখুন <font color="#336600">rightCategory</font> items.<br/>',
							' আইটেম এক সময়ে এক প্রদর্শিত হবে.',
							'<br/>',
							' আপনি যদি ভুল করেন তাহলে একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। অন্য দিকে স্পর্শ করুন। নির্ভুল থাকাকালীন <u> যত দ্রুত যেতে পারেন </u> .<br/>',
						'</p>',
						'<p align="center"> শুরু করতে <b> নীচের </b> সবুজ এলাকায় স্পর্শ করুন.</p>',
